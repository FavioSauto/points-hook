...
import {Hooks} from "v4-core/libraries/Hooks.sol";
  ...
  contract PointsHook is BaseHook, ERC1155 {
    ...
    function _afterSwap(
      ...
      //   amounts of ETH they spent is equal to |amountSpecified|
      // if amountSpecified > 0:
      //   this is an "exact ouput for input" swap
    ...
    function _assignPoints(
      ...
      // If there is hookData but not in the format we're expecting and user addess is zero
